...
from ...execute.utils import WASM_VALUE, clamp, trap, wasm_fnearest, wasm_fsqrt, wasm_iadd, wasm_iclz, wasm_ictz, wasm_idiv_signed, wasm_idiv_unsigned, wasm_imul, wasm_ipopcnt, wasm_irem_signed, wasm_isub
...
BIOP_FUNC: Dict[
    ...
    'ishl': lambda a, b, _: a + b,
    'ishr_s': lambda a, b, _: a + b,
    'ishr_u': lambda a, b, _: a + b,
